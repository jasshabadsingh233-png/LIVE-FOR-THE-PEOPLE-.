...
st.write(f"**Engine Status:** ACTIVE | **Global Connectivity:** 100% | **Liquidity:** ₹{st.session_state.balance:,.2f}")
...
with tabs[1]:
    ...
    with c_reb1:
        st.plotly_chart(px.bar(reb_df, x='Asset', y='Req. Gain %', color='Req. Gain %', color_continuous_scale='Reds', title="Recovery Gradient"), use_container_width=True)
    with c_reb2:
